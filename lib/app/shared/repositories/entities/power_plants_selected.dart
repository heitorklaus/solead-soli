...
part 'power_plants_selected.g.dart';
...
class PowerPlantsSelected extends _PowerPlantsSelected with _$PowerPlantsSelected {
  ...
  factory PowerPlantsSelected.fromJson(Map json) {
    return PowerPlantsSelected(
        // id: json['id'],
 ...
 */
abstract class _PowerPlantsSelected with Store {
  @observable
  int id;
  @observable
