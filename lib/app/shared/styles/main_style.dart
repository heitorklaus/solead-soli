...
//----------------------------------------------------------------- Headings
final heading16Bold = TextStyleGenerator()
    .getMontserratStyle(size: 16, color: Colors.black, weight: FontWeight.w700);
...
final ubuntu16BlackBold500 = TextStyleGenerator()
    .getUbuntuStyle(size: 16, color: Colors.black, weight: FontWeight.w500);

final ubuntu14WhiteLight100 = TextStyleGenerator()
    .getUbuntuStyle(size: 14, color: Colors.white, weight: FontWeight.w100);

final ubuntu14BlackLight100 = TextStyleGenerator().getUbuntuStyle(
    size: 14, color: MainColors.cloudy300, weight: FontWeight.w100);

final museo14Sky700 = TextStyleGenerator().getMontserratStyle(
    color: MainColors.cielo, size: 14, weight: FontWeight.w700);
