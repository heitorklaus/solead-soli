...
class SimulatorPage extends StatefulWidget {
  ...
  final int qtd;
  final String mode;
  SimulatorPage({Key key, this.title = "Simulator", this.qtd, this.mode})
      : super(key: key);
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                'Propostas Simuladas',
                style: ubuntu16BlackBold500.copyWith(
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  '10/09/2019',
                  style: buttonLargeBlue.copyWith(
                ...
                Text(
                  'R\$ 25.651,12',
                  style: buttonLargeBlue.copyWith(
                      color: Colors.blue[500], fontWeight: FontWeight.normal),
                ),
                SizedBox(
                  width: 10,
                )
