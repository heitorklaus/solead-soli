...
class SimulatorEditPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: SimulatorClass(title: 'Flutter Slidable Demo'),
    );
  }
}

class SimulatorClass extends StatefulWidget {
  SimulatorClass({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SimulatorClassState createState() => _SimulatorClassState();
}

class _SimulatorClassState extends State<SimulatorClass> {
  ...
  Future asyncOperation() async {
    List v = await HomeController().getLeads();
    items = List.generate(
      v.length,
      (i) => _HomeItem(
        i,
